      ...
      <div className="container mx-auto px-4">
        <div className="bg-white p-5 py-5 w-full max-w-md mx-auto">
          ...
          >
            ...
            <button className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 w-full max-w-[150px] rounded-full mx-auto hover:scale-95 transition-all block mt-3">
              Login
            </button>
          </form>
          <div className="flex">
            ...
            {/* <p className="ml-24 mt-4 text-red-600 hover:underline hover:text-red-600">
